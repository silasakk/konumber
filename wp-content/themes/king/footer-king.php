<div class="w-section footer-section">
    <div class="w-container">
        <div class="footer-list">
            <div class="w-row">
                <div class="w-col w-col-4"><img class="footer-logo" src="<?php echo get_template_directory_uri() ?>/images/logo.png">
                    <div class="webname">kingofnumber.com</div>
                </div>
                <div class="w-col w-col-4">
                    <div class="footer-contact">CALL CENTER | 095-998-9656
                        <br>LINE ID | KINGOFNUMBER</div>
                    <div class="footer-menu">หน้าหลัก | เกี่ยวกับเรา | ร้่านค้า | ติดต่อเรา</div>
                </div>
                <div class="w-col w-col-4"><img class="fbb" src="<?php echo get_template_directory_uri() ?>/images/fbb.png">
                </div>
            </div>
        </div>
    </div>
